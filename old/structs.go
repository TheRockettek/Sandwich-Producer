...
// A VoiceConnection represents the state of a member.
...
type Session struct {
	...
	// used to store global event channel
	EventChannel chan Event
	...
	// We store a list of all guilds that were unavailable in READY packet
	// so we can differenciate guild joins and initial objects
